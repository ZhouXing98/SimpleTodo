...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder> {
    ...
    // Responsible for taking data of a particular position and put it into a viewholder
    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position){
        //Grab the data of the position
        String item = items.get(position);
        //Bind the data into the specified view holder
        holder.bind(item);
    }
        ...
        public void bind(String item) {
            ...
            tvItem.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    // Notifying the listener which position is long pressed
